...
public class DataResourceUtils {
	...
	public static final String[] drawerItemsTitles = { "美食餐馆", "我的订单", "位置定位",
			"买家秀", "精品推荐" };
	...
	public static final String[] categoryItems = { "龙虾叔叔", "周黑鸭", "水饺妞妞" };

	public static final int[] categoryItemsImages = { R.drawable.category1,
			R.drawable.category2, R.drawable.category3 };
