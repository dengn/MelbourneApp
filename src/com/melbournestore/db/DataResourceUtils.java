...
public class DataResourceUtils {
	...
	public static final String[] drawerItemsTitles = { "ÃÀÊ³²Í¹İ", "ÎÒµÄ¶©µ¥", "Î»ÖÃ¶¨Î»",
			"Âò¼ÒĞã", "¾«Æ·ÍÆ¼ö" };
	...
	public static final String[] shopItems = { "ÁúÏºÊåÊå", "ºÚÍèÄÛÏÉ²İ", "Ë®½Èæ¤æ¤" };
	...
	public static final String[][] plateNames = {
			{ "ÂéÀ±Ğ¡ÁúÏº", "ËâÄàĞ¡ÁúÏº", "Åİ½·Ğ¡ÁúÏº", "¿§à¬Ğ¡ÁúÏº", "Ğ¡ÁúÏº³´Äê¸â" },
			{ "AÌ×²Í", "BÌ×²Í", "CÌ×²Í", "DÌ×²Í", "EÌ×²Í" },
			{ "Ë®½È", "¼å½È", "ÖíÈâË®½È", "ÇÛ²ËË®½È", "°×²ËË®½È" } };
